...
import { Building, MessageSquare, Facebook, Linkedin } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="https://wa.me/8801920709034" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors"><MessageSquare /></Link>
